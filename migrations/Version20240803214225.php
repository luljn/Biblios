 ...
 */
final class Version20240803214225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, editor_id INT NOT NULL, title VARCHAR(255) NOT NULL, isbn VARCHAR(255) NOT NULL, cover VARCHAR(255) NOT NULL, page_number INT NOT NULL, status VARCHAR(255) NOT NULL, edited_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, plot TEXT DEFAULT NULL, PRIMARY KEY(id))');
